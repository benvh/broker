Gem::Specification.new do |s|
	...
	s.homepage		= 'http://i.have.no.homepage.com'

	s.add_dependency "rack"
	s.add_dependency "mongrel"

	s.files			= ["bin/broker", "lib/broker.rb", "lib/broker/proxy.rb", "lib/broker/request.rb", "lib/broker/request_handler.rb", "lib/broker/config.rb"]
